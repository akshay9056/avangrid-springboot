...
// 🔹 Fetch result
    ...
    public static ResponseEntity<?> testSampleRecording(String filename, String date, String opco) {

        if(Objects.equals(filename, "success")){
            try {
                // Load file from resources (src/main/resources/audio/sample.mp3)
                ClassPathResource audioFile = new ClassPathResource("audio/audio1.mp3");
